...
<body>
            ...
            <nav class="flex items-center justify-between flex-wrap bg-gray-200 p-6 shadow-xl mb-1 ">
                ...
                <!-- Breadcrumbs -->
            <div class="text-black font-bold my-2" aria-label="Breadcrumb">
                <ol class="list-none pl-2 inline-flex">
	            ...
	            <div class=\"flex flex-col \">
                   ...
                   ";
                    ...
                    <form >
                        ...
                        <div class="mt-4 w-full lg:w-1/2 px-3 mb-6 md:mb-0">
    ...
    <!-- Product Description -->
    <div class="flex flex-col border mx-4">
        <div class="flex justify-around">
            <span class="px-4 border-b ">Product Details<br></span>
            <span class="px-4 ">Reviews<br></span>
            <span class="px-4 ">Delivery & Returns<br></span>
        </div>
        <div class="text-gray-700 text-center  px-4 py-2 m-2"> Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt, corporis. Excepturi sit repellat asperiores quia autem incidunt ipsum veritatis at ratione. Non, rem. Earum, recusandae alias nemo tempore modi cupiditate!</div>
      </div>

      <!-- Recommender System -->
      <div class="flex justify-center text-center w-full h-12 mt-4">
      ...
      <div class=" flex flex-wrap items-center justify-center">
        <div class="flex-shrink-0 m-6 relative overflow-hidden bg-orange-500 rounded-lg max-w-xs shadow-lg">
          ...
          <div class="relative pt-10 px-10 flex items-center justify-center">
            ...
            <img class="relative w-40" src="assets/images/mx-master-3.png" alt="">
          </div>
          <div class="relative text-white px-6 pb-6 mt-6">
            <span class="block opacity-75 -mb-1">Mouse</span>
            <div class="flex justify-between">
              <span class="block font-semibold text-;g">Logitech MX2</span>
