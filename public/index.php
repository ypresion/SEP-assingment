...
<div class="flex flex-col lg:flex-row  mt-2">
    <div class="w-full lg:w-1/3 h-auto p-2  md:text-xl ">
        <button class="w-full p-2 bg-gray-800 hover:bg-gray-500 text-white font-semibold hover:text-white  border border-gray-400 hover:border-transparent rounded">
