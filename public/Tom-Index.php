...
<body>
    <!-- Navigation -->
    <nav class="flex items-center justify-between flex-wrap bg-gray-500 p-6 shadow-xl mb-1 ">
       <?php
       require_once "functions.php";
       if(check_login()) {
        echo "<div>
        ...
        echo"<div>
            <a href=\"loginForm.html\" class=\"inline-block text-sm px-4 py-2 leading-none border rounded text-gray-900 border-gray-800 hover:border-transparent hover:text-teal-500 hover:bg-white mt-4 lg:mt-0\">Login</a>
        </div>";
        }
        ?>
    ...
    <div class="flex flex-wrap">
        <div class="w-full sm:w-1/2 bg-gray-500 h-10">
        </div>
        <div class="w-full sm:w-1/2 bg-gray-900 h-10">
        </div>
    </div>
    ...
    <div class="flex flex-col flex-wrap  ">
        <div class="flex justify-around bg-red-400">
